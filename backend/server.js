...
const frontendPublicDir = serveFrontend ? path.resolve(__dirname, process.env.FRONTEND_ROOT || '../frontend') : null;
...
if (serveFrontend && frontendPublicDir && fs.existsSync(frontendPublicDir)) {
