const AdminAPI = (() => {
  ...
  return {
    ...
    getUserEsims: (userId) => request(`/users/${userId}/esims`).then(result => ({ esims: result.esims || [] })),
    getKyc: () => request('/kyc'),
    ...
    updateUserEsim: (id, data) => request(`/esims/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
